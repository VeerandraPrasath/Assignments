...
namespace InventoryManagerTests
{
    public class InventoryManagerTest
    {
        ...
        public void AddNewProduct_AddProductTOList(int id, string name, int quantity, int price)
        {
            ...
            _userInteraction.Setup(mock => mock.GetProductDetails()).Returns(product);
        ...
        [TestCase("Prasath")]
        [TestCase("1")]
        public void DeleteExistingProduct_DeleteProduct_When_ProductExist(string inputString)
        {
        ...
        [TestCase("Arun")]
        [TestCase("2")]
        public void DeleteExistingProduct_NotDeleteProduct_When_ProductNotExist(string inputString)
        {
            StringWriter stringWriter = new StringWriter();
            Console.SetOut(stringWriter);
        ...
        public void EditExistingProduct_EditProductName_When_OptionIs1(string inputString, string newName, string userOption)
        {
        ...
        [TestCase("Arun", 5, "2")]
        public void EditExistingProduct_EditProductId_When_OptionIs2(string inputString, int newId, string userOption)
        {
            _productRepository.Setup(mock => mock.GetAllProducts()).Returns(_productList);
            _userInteraction.Setup(mock => mock.GetInputString(It.IsAny<string>())).Returns(inputString);
            _productRepository.Setup(mock => mock.FindProduct(inputString)).Returns(_product1);
        ...
        [TestCase("Arun", 40, "3")]
        public void EditExistingProduct_EditProductQuantity_When_OptionIs3(string inputString, int newQuantity, string userOption)
        {
            _productRepository.Setup(mock => mock.GetAllProducts()).Returns(_productList);
            _userInteraction.Setup(mock => mock.GetInputString(It.IsAny<string>())).Returns(inputString);
            _productRepository.Setup(mock => mock.FindProduct(inputString)).Returns(_product1);
        ...
        [TestCase("Arun", 20, "4")]
        public void EditExistingProduct_EditProductPrice_When_OptionIs4(string inputString, int newPrice, string userOption)
        {
            _productRepository.Setup(mock => mock.GetAllProducts()).Returns(_productList);
            _userInteraction.Setup(mock => mock.GetInputString(It.IsAny<string>())).Returns(inputString);
            _productRepository.Setup(mock => mock.FindProduct(inputString)).Returns(_product1);
        ...
        [TestCase("1", true)]
        [TestCase("Arun", true)]
        public void SearchProducts_ReturnProduct_When_ProductExist(string inputString, bool expected)
        {
            _productRepository.Setup(mock => mock.GetAllProducts()).Returns(_productList);
            _userInteraction.Setup(mock => mock.GetInputString(It.IsAny<string>())).Returns(inputString);
            _productRepository.Setup(mock => mock.FindProduct(inputString)).Returns(_product1);
        ...
        public void SearchProducts_ReturnNull_When_ProductNotExist(string inputString, bool expected)
        {
            _productRepository.Setup(mock => mock.GetAllProducts()).Returns(_productList);
            _userInteraction.Setup(mock => mock.GetInputString(It.IsAny<string>())).Returns(inputString);
            _productRepository.Setup(mock => mock.FindProduct(inputString)).Returns((Product)null);
