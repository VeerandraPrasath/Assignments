...
var repositoryInteraction = new RepositoryInteraction(userInteraction, fileInteraction, "UserList.json",new List<User>());
var manageTracker = new ManageTracker(userInteraction, repositoryInteraction,null);
